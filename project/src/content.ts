...
export const projects = [
  { title: 'LaneLab', category: 'Software', type: 'Swimming software · Active project', description: 'A workspace for the way coaches actually plan a practice. I built LaneLab around my experience on both sides of the pool: swimming and coaching.', detail: 'Practice building, lane organization, race analysis, pacing tools, AI coaching and printable deck sheets. Built with React, TypeScript, Cloudflare Workers, D1 and Gemini. Presented with Yichen Liu for CAYIA 2026.', image: '/portfolio/lanelab.jpg', tags: ['React / TypeScript', 'Cloudflare', 'Gemini'], url: 'https://lanelab.studio', label: 'Open LaneLab', featured: true },
  ...
  { title: 'Freestyle pacing with calculus', category: 'Software', type: 'Independent modeling project', description: 'A Python and Streamlit project exploring the connection between calculus, pacing and swimming performance.', detail: 'An independent modeling study, with code and a written report.', tags: ['Python', 'Streamlit', 'Mathematical modeling'], url: 'https://github.com/shayan2008/Calculus-Optimization-of-200-Free', label: 'View source' },
];
export const awards = [
